                ...
                function limitarDireccion(e, contenido, caracteres)
                {
                    ...
                    if (contenido.length > caracteres) {
                        swal({title: "Advertencia!",
                            text: "Ha ingresado 100 caracteres no podrá ingresar más",
                            type: "warning",
                    ...
                    <div class="col-md-12" style="padding-top: 5px">
                        ...
                        <ul class="nav nav-pills">
                            ...
                            if ($usuarioSesion->getCOD_TIPO_USU() == "TUSU-0001") {
                                echo "<li role = 'presentation'><a href = '#nuevoUSU' data-toggle = 'modal'><h4><span class='glyphicon glyphicon-plus'></span> NUEVO USUARIO</h4></a></li>";
